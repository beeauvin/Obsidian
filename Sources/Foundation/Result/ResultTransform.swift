...
public extension Result {
  ...
  func transform<NewSuccess>(_ transformer: (Success) -> NewSuccess) -> Result<NewSuccess, Failure> {
    switch self {
  ...
  func transform<NewSuccess>(_ transformer: (Success) -> Result<NewSuccess, Failure>) -> Result<NewSuccess, Failure> {
    switch self {
      case .success(let value):
  ...
  /// - Returns: A result containing the transformed value, or the original error if the original was a failure
  func transform<NewSuccess>(_ transformer: (Success) async -> NewSuccess) async -> Result<NewSuccess, Failure> {
    switch self {
      case .success(let value):
  ...
  /// - Returns: The result of the transformation, or the original error if the original was a failure
  func transform<NewSuccess>(_ transformer: (Success) async -> Result<NewSuccess, Failure>) async -> Result<NewSuccess, Failure> {
    switch self {
      case .success(let value):
