...
public extension Result {
  ...
  @discardableResult
  func when(success action: (Success) -> Void) -> Self {
  ...
  /// - Returns: The original result, allowing for method chaining
  @discardableResult
  func when(failure action: (Failure) -> Void) -> Self {
  ...
  /// - Returns: The original result, allowing for method chaining
  @discardableResult
  func when(success action: (Success) async -> Void) async -> Self {
    if case .success(let value) = self {
      await action(value)
    }
    return self
  ...
  /// - Returns: The original result, allowing for method chaining
  @discardableResult
  func when(failure action: (Failure) async -> Void) async -> Self {
    if case .failure(let error) = self {
      await action(error)
    }
    return self
