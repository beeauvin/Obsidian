...
public extension Result {
  ...
  func reframe<NewFailure>(_ transformer: (Failure) -> NewFailure) -> Result<Success, NewFailure> {
    switch self {
  ...
  func reframe<NewFailure>(_ transformer: (Failure) -> Result<Success, NewFailure>) -> Result<Success, NewFailure> {
    switch self {
      case .success(let value):
        return .success(value)
      case .failure(let error):
  ...
  /// - Returns: A result containing the original success value, or the transformed error if the original was a failure
  func reframe<NewFailure>(_ transformer: (Failure) async -> NewFailure) async -> Result<Success, NewFailure> {
    switch self {
      case .success(let value):
        return .success(value)
      case .failure(let error):
  ...
  /// - Returns: The original success, or the result of the transformation if the original was a failure
  func reframe<NewFailure>(_ transformer: (Failure) async -> Result<Success, NewFailure>) async -> Result<Success, NewFailure> {
    switch self {
      case .success(let value):
        return .success(value)
      case .failure(let error):
