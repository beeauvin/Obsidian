...
public extension Result {
  ...
  func otherwise(_ default: Success) -> Success {
    switch self {
  ...
  func otherwise(_ provider: () -> Success) -> Success {
    switch self {
      case .success(let value):
        return value
      case .failure:
  ...
  func otherwise(_ provider: (Failure) -> Success) -> Success {
    switch self {
      case .success(let value):
        return value
  ...
  func otherwise(_ provider: () async -> Success) async -> Success {
    switch self {
      case .success(let value):
        return value
      case .failure:
  ...
  func otherwise(_ provider: (Failure) async -> Success) async -> Success {
    switch self {
      case .success(let value):
        return value
      case .failure(let error):
