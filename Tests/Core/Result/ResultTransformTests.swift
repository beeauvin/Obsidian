...
@Suite("Obsidian/Foundation/Result: Transform")
struct ResultTransformTests {
  ...
  @Test("transform(_:) with result returning transformer returns transformed result when success and transformation succeeds")
  ...
  @Test("transform(_:) with result returning transformer returns failure when success but transformation fails")
  ...
  @Test("transform(_:) with async result returning transformer returns transformed result when success and transformation succeeds")
  func transform_async_result_returns_transformed_result_when_success_and_transformation_succeeds() async throws {
    // Given
    let result: Result<Int, TestError> = .success(21)
  ...
  @Test("transform(_:) with async result returning transformer returns failure when success but transformation fails")
