...
@Suite("Obsidian/Foundation/Result: Recover")
struct ResultRecoverTests {
  ...
  @Test("recover(_:) with async closure returns recovered success when failure and recovery succeeds")
  ...
  @Test("recover(_:) with async result returns recovered success when failure and recovery succeeds")
  func recover_async_with_result_returns_recovered_success_when_failure_and_recovery_succeeds() async throws {
    // Given
    let original = Result<String, TestError>.failure(.expected)
