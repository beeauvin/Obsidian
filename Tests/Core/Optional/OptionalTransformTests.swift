...
struct OptionalTransformTests {
  ...
  func transform_returns_transformed_value_when_non_nil() throws {
    // Given
    let optional: Optional<String> = "Hello"
  ...
  @Test("transform(_:) with optional returning transformer returns transformed value when non-nil and transformation succeeds")
  func transform_optional_returns_transformed_value_when_non_nil_and_transformation_succeeds() throws {
    // Given
    let optional: Optional<String> = "Hello"
  ...
  @Test("transform(_:) with async optional returning transformer returns transformed value when non-nil and transformation succeeds")
  func transform_async_optional_returns_transformed_value_when_non_nil_and_transformation_succeeds() async throws {
    // Given
    let optional: Optional<Int> = 21
  ...
  @Test("transform(_:) with async optional returning transformer returns nil when transformation fails")
