...
public extension Optional {
  ...
  func transform<Transformed>(_ transformer: (Wrapped) -> Transformed) -> Transformed? {
  ...
  /// - Returns: An optional containing the transformed value, or nil if the original was nil
  func transform<Transformed>(_ transformer: (Wrapped) async -> Transformed) async -> Transformed? {
    if let wrapped = self {
